public class SwaggerConfiguration
{
    ...
    /// </summary>
    public const string ContactName = "API DEMO";

    /// <summary>
    /// <para>http://geeks.ms/jorge/</para>
    /// </summary>
    public const string ContactUrl = "github.com";
    ...
    /// <para>Foo API</para>
    /// </summary>
    public const string DocInfoTitle = "API DEMO";
    ...
    /// </summary>
    public const string DocInfoDescription = "Api - Sample Web API in ASP.NET Core 2";
